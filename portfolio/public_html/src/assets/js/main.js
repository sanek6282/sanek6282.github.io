        ...
        $form.validate({
          ...
          submitHandler: function(form) {
            $.ajax({
              ...
              error: function(XMLHttpRequest, textStatus, errorThrown) {
                $formNotify.html('<span class="form-icon-error"></span> Ошибка. Попробуйте позже.').show();
              },
            });
          },
          invalidHandler: function(event, validator) {
            ...
            if (errors) {
              ...
              '<span class="form-icon-error"></span>Вы не заполнили 1 поле.' :
              '<span class="form-icon-error"></span>Вы не заполнили ' + errors + ' поля.';
